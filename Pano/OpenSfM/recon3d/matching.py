...
from recon3d.unionfind import UnionFind
...
def create_tracks_graph(features, colors, matches, config):
    ...
    uf = UnionFind()
    for im1, im2 in matches:#eg (2,3)
        for f1, f2 in matches[im1, im2]:#these are matching keypoints
            uf.union((im1, f1), (im2, f2))
            print 'im1: ',im1,' im2: ',im2,' f1: ',f1,' f2: ',f2
        # raw_input()
