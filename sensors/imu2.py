...
class IMU(object):
    ...
    def read_pitch_roll_yaw_full(self):
        '''
        Return pitch, roll and yaw in radians
        '''
        try:
            ...
            return (self.pitch, self.roll, self.yaw, self.gyro_scaled_x, self.gyro_scaled_y, self.gyro_scaled_z, False)
        return (self.pitch, self.roll, self.yaw, self.gyro_scaled_x, self.gyro_scaled_y, self.gyro_scaled_z, True)
